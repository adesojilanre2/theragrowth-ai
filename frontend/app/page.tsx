...
const STRIPE_GROWTH = "https://buy.stripe.com/3cI6oJdzff9a1ElfVX2sM09";
    ...
    <main className="min-h-screen bg-[#fbf5e9] text-[#111111]">
      <header className="sticky top-0 z-50 border-b border-[#decba8] bg-[#fbf5e9]/95 px-6 py-5 backdrop-blur md:px-[6%]">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <a href="#top" className="flex items-center gap-4 text-inherit no-underline">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#111111] font-serif text-2xl font-black text-[#d6a72c]">
              TG
            </div>
            <div>
      ...
      <section id="top" className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-[1.35fr_0.9fr] md:px-[6%] md:py-24">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#audit"
              className="rounded-2xl bg-[#111111] px-7 py-4 font-black text-white no-underline"
            >
              Request Free Audit
            </a>
            <a
              href="#pricing"
              className="rounded-2xl border border-[#d7c4a8] px-7 py-4 font-black text-[#111111] no-underline"
            >
              View Growth Plans
            </a>
          </div>
        ...
        <div className="rounded-[2rem] border border-[#decba8] bg-white p-8 shadow-sm md:p-10">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#111111] font-serif text-2xl font-black text-[#d6a72c]">
            TG
          </div>
          <h2 className="mb-5 font-serif text-3xl leading-tight">
            A complete client acquisition engine for private practices.
          </h2>
          <ul className="mb-7 space-y-3 text-lg leading-relaxed text-[#263b58]">
          ...
          <a
            href="#pricing"
            className="inline-block rounded-2xl bg-[#111111] px-6 py-4 font-black text-white no-underline"
          >
            Start Monthly SaaS
          </a>
        </div>
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-20 md:px-[6%]">
        ...
        <h2 className="mb-10 font-serif text-4xl leading-tight md:text-6xl">
          What TheraGrowth AI Builds
        </h2>

        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
            <h3 className="mb-3 text-2xl font-bold">Website Conversion Audit</h3>
          ...
          <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
            <h3 className="mb-3 text-2xl font-bold">AI Chat Lead Capture</h3>
            <p className="text-lg leading-relaxed text-[#263b58]">
          ...
          <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
            <h3 className="mb-3 text-2xl font-bold">Follow-Up System</h3>
            <p className="text-lg leading-relaxed text-[#263b58]">
      ...
      <section id="pricing" className="bg-[#111111] px-6 py-20 text-white md:px-[6%]">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mb-10 font-serif text-4xl leading-tight md:text-6xl">
            Simple Monthly Growth Plans
          </h2>

          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-[1.75rem] border border-[#333333] bg-[#1b1b1b] p-8">
              <h3 className="text-2xl font-bold">Starter</h3>
              <h4 className="my-4 font-serif text-4xl text-[#d6a72c]">$99/mo</h4>
              <p className="text-lg leading-relaxed text-[#8fa3c3]">
                Start getting more private-pay client inquiries from your website.
              </p>
            ...
            <div className="rounded-[1.75rem] border-2 border-[#d6a72c] bg-[#1b1b1b] p-8">
              ...
              <h4 className="my-4 font-serif text-4xl text-[#d6a72c]">$299/mo</h4>
              <p className="text-lg leading-relaxed text-[#8fa3c3]">
                Turn more website visitors into booked therapy sessions.
              </p>
              <ul className="my-7 space-y-3 leading-relaxed">
            ...
            <div className="rounded-[1.75rem] border border-[#333333] bg-[#1b1b1b] p-8">
              ...
              <h4 className="my-4 font-serif text-4xl text-[#d6a72c]">$750+</h4>
              <p className="text-lg leading-relaxed text-[#8fa3c3]">
                We help you build a complete client acquisition system.
              </p>
              <ul className="my-7 space-y-3 leading-relaxed">
      ...
      <section id="process" className="mx-auto max-w-7xl px-6 py-20 md:px-[6%]">
        ...
        <h2 className="mb-10 font-serif text-4xl leading-tight md:text-6xl">How Clients Start</h2>

        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
            <h3 className="mb-3 text-2xl font-bold">1. Submit Audit</h3>
            <p className="text-lg leading-relaxed text-[#263b58]">
              The therapist sends website and practice details.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
            <h3 className="mb-3 text-2xl font-bold">2. Receive Growth Review</h3>
            <p className="text-lg leading-relaxed text-[#263b58]">
              You review their site and explain where leads are being lost.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
            <h3 className="mb-3 text-2xl font-bold">3. Sell the System</h3>
            <p className="text-lg leading-relaxed text-[#263b58]">
              Offer SaaS, setup, or monthly growth support.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="dashboard" className="bg-[#fff3df] px-6 py-20 md:px-[6%]">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mb-10 font-serif text-4xl leading-tight md:text-6xl">
            TheraGrowth Client Acquisition Dashboard
          </h2>

          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
              <h3 className="text-2xl font-bold">New Leads</h3>
              <p className="font-serif text-5xl font-bold">0</p>
            </div>
            <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
              <h3 className="text-2xl font-bold">Follow-Ups Due</h3>
              <p className="font-serif text-5xl font-bold">0</p>
            </div>
            <div className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
              <h3 className="text-2xl font-bold">Booked Calls</h3>
              <p className="font-serif text-5xl font-bold">0</p>
            </div>
          </div>
        </div>
      ...
      <section id="audit" className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:px-[6%]">
        <div>
          ...
          <h2 className="mb-7 font-serif text-4xl leading-tight md:text-6xl">
            Request Your Free Practice Growth Audit
          </h2>
          <p className="text-xl leading-relaxed text-[#263b58]">
            Submit your practice details and we will review your website, funnel,
        ...
        <form onSubmit={handleAuditSubmit} className="rounded-[1.75rem] border border-[#decba8] bg-white p-8">
          <input
            ...
            required
            className="mb-4 w-full rounded-2xl border border-[#d7c4a8] bg-white p-4 text-base text-[#111111]"
          />
          <input
            name="email"
            type="email"
          ...
          <textarea
            ...
            onChange={updateField}
            className="mb-4 min-h-[150px] w-full rounded-2xl border border-[#d7c4a8] bg-white p-4 text-base text-[#111111]"
          />
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-2xl bg-[#111111] px-6 py-4 text-lg font-black text-white disabled:opacity-60"
          >
      ...
      <footer className="bg-[#111111] px-6 py-12 text-white md:px-[6%]">
        <div className="mx-auto max-w-7xl">
          ...
          <p>
            Email: {" "}
            <a href="mailto:hello@theragrowth-ai.com" className="font-black text-[#d6a72c]">

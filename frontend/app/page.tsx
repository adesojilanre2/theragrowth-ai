    ...
    <main style={pageStyle}>
      <header style={headerStyle}>
        ...
        <nav style={navStyle}>
          ...
          <a
            ...
            aria-label="TheraGrowth AI Instagram"
            title="Follow TheraGrowth AI on Instagram"
          >
            <InstagramIcon />
            <span style={instagramTextStyle}>Instagram</span>
          </a>
        </nav>
      </header>
      ...
      <section id="top" style={heroStyle}>
        <div style={heroTextStyle}>
          ...
          <p style={microTrustStyle}>
            Built for therapists who want more direct inquiries, better trust, and less dependence on directories.
          </p>
        </div>

        <div style={heroCardStyle}>
          <div style={miniLogoStyle}>TG</div>
          <p style={cardEyebrowStyle}>Growth System</p>
          <h2 style={cardTitleStyle}>A complete client acquisition engine for private practices.</h2>
          <ul style={checkListStyle}>
            <li>Website that builds trust</li>
            <li>Clear booking path</li>
            <li>AI chat for visitor questions</li>
            <li>CRM for every inquiry</li>
            <li>Follow-up system so leads do not disappear</li>
          </ul>
        </div>
      </section>
      ...
      <section id="services" style={darkSectionStyle}>
        ...
        <div style={serviceGridStyle}>
          <ServiceCard title="Premium Website" text="A clean, mobile-first site designed to create trust and convert visitors into consultation requests." />
          ...
          <ServiceCard title="Lead Capture Funnel" text="Forms, calls-to-action, and follow-up paths designed to move visitors from interest to inquiry." />
          <ServiceCard title="Growth Strategy" text="We review your website, Instagram, offer, trust signals, and follow-up system so you know what to fix first." />
        </div>
      </section>
      ...
      <section id="packages" style={packagesSectionStyle}>
        ...
        <p style={sectionLeadStyle}>
          Start with a focused audit, install the starter system, or build the full client-growth machine.
        </p>
      ...
      <section style={proofSectionStyle}>
        <p style={eyebrowStyle}>Why It Works</p>
        <h2 style={h2Style}>Clients Are Already Searching. Your System Must Help Them Choose You.</h2>
        <div style={proofGridStyle}>
          <ProofCard title="Trust" text="Your website must quickly show who you help, how you help, and why you can be trusted." />
          <ProofCard title="Clarity" text="Visitors should know exactly what to do next without confusion." />
          <ProofCard title="Follow-Up" text="Every inquiry should be tracked, followed up, and moved toward a consultation." />
        </div>
      </section>
      ...
      <section id="audit" style={formSectionStyle}>
        <div>
          ...
          <p style={leadStyle}>
            ...
            You can also use the paid audit if you want a deeper action plan.
          </p>
...
function ProofCard({ title, text }: { title: string; text: string }) {
  return (
    <div style={proofCardStyle}>
      <h3 style={proofTitleStyle}>{title}</h3>
  ...
  return (
    <div style={featured ? featuredPriceCardStyle : priceCardStyle}>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        style={featured ? lightButtonStyle : primaryButtonStyle}
      >
        Pay Now
      </a>
    </div>
...
const navStyle = { display: "flex", gap: 20, alignItems: "center", flexWrap: "wrap" } as const;
const navLinkStyle = { color: black, textDecoration: "none", fontWeight: 700 } as const;
...
const heroTextStyle = { maxWidth: 820 } as const;
...
const microTrustStyle = { color: "#6b5b48", fontWeight: 800, marginTop: 20 } as const;
...
const cardEyebrowStyle = { color: gold, fontWeight: 900, letterSpacing: 2, textTransform: "uppercase" } as const;
...
const proofTitleStyle = { fontFamily: "Georgia, serif", fontSize: 30, color: gold, margin: "0 0 8px" } as const;
const proofTextStyle = { color: "#3d3328", lineHeight: 1.7, margin: 0 } as const;
